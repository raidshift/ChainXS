...
let P2WPKH_KEY: Int = 3
let XPUB_KEY = 4
let YPUB_KEY = 5
let ZPUB_KEY = 6
let ETH_ADDRESS_KEY = 7
let TRX_ADDRESS_KEY = 8
let KAS_ADDRESS_KEY = 9
let PRIV_KEY = 10
let WIF_KEY = 11
let XPRV_KEY = 12
let YPRV_KEY = 13
...
let DERIVATION_PATHS: [DERIVATION_PATH: (path: String, atLevel: Int, desc: String)] =
    [
        ...
        .BIP44_KAS_DERIVATION_PATH: ("m/44'/111111'/0'/0/0", 3, "BIP44 (Kaspa)"),
...
enum ChainXSContext {
    ...
    static func setNetwork(_ network: Network) {
        ...
        case .TEST:
            ...
            ChainXSContext.kaspaPrefix = "kaspatest"
            ChainXSContext.kaspaVersion = 0
        }
